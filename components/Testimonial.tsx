    ...
    <section className="py-10 " id="testimonials">
      <div className="w-full mx-auto px-4">
        ...
        <p className="text-gray-500 text-center mt-2 mb-8">
          ...
          Illum corporis magnam tempore dolorem, repellendus optio et quis nihil
          eveniet dolorum. Quidem distinctio mollitia quisquam, fuga qui vero
          magnam?
        </p>
        <Carousel
        opts={{
              ...
              >
                <div className={`w-full h-full rounded-lg p-6 flex flex-col items-center gap-6 ${item.bgColor}` }>
                  <div className="w-24 h-24">
                    <User2 className="w-ful h-full text-gray-500"/>
